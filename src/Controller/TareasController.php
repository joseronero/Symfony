...
class TareasController extends Controller {
    ...
    /**
     * @Route("/tareas/inicio", name="_inicio")
     */
    ...
    /**
     * @Route("/tareas/login", name="_login_seguro" )
     */
    public function login (Request $request, AuthenticationUtils $authUtils)
    {
     ...
     /**
     * @Route("/tareas/nuevousuario", name="_nuevo_usuario")
     */
    ...
    /**
     * @Route("/tareas/crearusuario", name="_crear_usuario")
     * 
    ...
    public function listarUsuarios() {
     ...
     /**
     * @Route("/tareas/editarusuario/{id}", name="_editar_usuario" )
     */
    ...
    /**
     * @Route("/tareas/updateusuario/{id}", name="_update_usuario")
     * @param \App\Controller\Request $request
     */
    ...
    private function recuperaPassword($id){
     ...
     /**
     * @Route("/tareas/verusuario/{id}", name="_ver_usuario" )
     */
    ...
    /**
     * @Route("/tareas/borrarusuario/{id}", name="_borrar_usuario")
     * @param \App\Controller\Request $request
     */
